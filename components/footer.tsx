...
export function Footer() {
  ...
  return (
    <footer className="mt-6">
      {/* тонкая линия */}
      <div className="h-px w-full bg-[linear-gradient(90deg,transparent,rgba(90,215,255,0.22),transparent)]" />

      <div className="border-t border-line/70 bg-[linear-gradient(180deg,rgba(0,0,0,0.28),rgba(0,0,0,0.12))] backdrop-blur">
        <Container className="py-7">
          <div className="grid grid-cols-1 gap-8 md:grid-cols-12 md:items-start">
            ...
            <div className="md:col-span-4">
              ...
              <p className="mt-3 text-sm text-muted leading-relaxed">
                Private ZEC brokerage for discreet, structured execution. Quotes confirmed in writing before payment.
              </p>
              ...
              <div className="mt-4 flex items-center gap-3">
                <a
                  ...
                  className="inline-flex h-9 w-9 items-center justify-center rounded-2xl border border-line/70 bg-[rgba(0,0,0,0.22)] text-muted shadow-[inset_0_1px_0_rgba(255,255,255,0.06)] motion-safe:transition motion-safe:hover:-translate-y-[1px] hover:text-accent hover:border-accent/40"
                >
                  <IconLinkedIn />
                </a>
                <a
          ...
          {/* Bottom bar */}
          <div className="mt-7 flex flex-col gap-3 border-t border-line/70 pt-5 text-xs text-muted md:flex-row md:items-center md:justify-between">
